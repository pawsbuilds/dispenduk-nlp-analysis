...
## 1. Pendahuluan
Proyek ini bertujuan untuk mengeksplorasi fenomena dan pola opini masyarakat terhadap kualitas layanan Dinas Kependudukan dan Pencatatan Sipil (Dispenduk Capil) Kota Surabaya melalui berbagai kanal digital. Menggunakan pendekatan **Unsupervised Machine Learning**, analisis ini berfokus pada pengungkapan isu-isu makro dan mikro tanpa adanya asumsi awal atau pelabelan manual terhadap data (exploratory research).
...
* **Instagram:** 1.217 data (Komentar pada akun resmi).
...
Analisis ini menerapkan arsitektur Hybrid NLP untuk mendapatkan kedalaman informasi yang komprehensif melalui dua lapisan pemodelan:
...
* **BERTopic - Micro Approach:** Memanfaatkan Sentence Embeddings (IndoBERT) untuk mengekstraksi topik yang lebih granular dan teknis. Model ini mengidentifikasi 6 topik spesifik termasuk masalah verifikasi akun aplikasi, prosedur penggantian foto KTP, hingga pemutakhiran biodata di lokasi tertentu (Pakal).
